#!/usr/bin/env bash
# ============================================================================
# Build a patched embloader.efi for the Headwaters Q6A image.
#
# Why this exists
# ---------------
...
if ! grep -q "HEADWATERS PATCH" embloader/src/menu/menus/text_menu.c; then
    fatal "patch did not insert HEADWATERS marker — upstream may have changed"
fi
